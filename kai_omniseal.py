...
def validate_code_integrity(context: str) -> bool:
    ...
    def _perform_validation(code_str: str) -> bool:
        ...
        dangerous_functions = {
            ...
            'import', 'importlib', 'importlib.import_module', '__import__', 'load_module',
        ...
        dangerous_attributes = {
            '__code__', '__closure__', '__dict__', '__class__', '__bases__', '__subclasses__', '__mro__',
            '__qualname__', '__module__', '__name__', '__package__', '__builtins__', '__globals__',
            '__annotations__', '__defaults__', '__self__', '__func__', '__get__', '__set__', '__delete__',
            '__getattr__', '__setattr__', '__delattr__', '__getattribute__', '__reduce__', '__reduce_ex__',
            '__dir__', '__repr__', '__str__', '__bytes__', '__file__', '__path__', '__loader__', '__spec__',
            '_protected', '_private', '__mangled'
        }
        ...
        if visitor.has_star_import:
            ...
            return False
        if '__' in normalized_code and ('__import__' in normalized_code or '__builtins__' in normalized_code):
