...
def handle_message(update: Update, context: CallbackContext) -> None: user_message = update.message.text.strip() name = update.message.from_user.first_name or "Chelli"
